...
const getColorByStatus = (props: any) => {
  const configByStatus: any = {
    ...
    success: {
      borderedColor: getTheme('success.main')(props),
      iconColor: getTheme('success.main')(props),
    },
    error: {
      borderedColor: getTheme('danger.main')(props),
      iconColor: getTheme('danger.main')(props),
    },
    select: {
